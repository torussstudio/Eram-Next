...
//   { id: "sitewide", label: "Site-wide Notification" },
//   { id: "ease", label: "EASE" },
...
//             Publish updates, circulars and event announcements across
//             institutions.
//           </p>
//         </div>
...
//                 type === "event" ? "grid-cols-2" : "grid-cols-1"
//               }`}
//             >
//               <div>
//                 <label className="font-rethink text-xs uppercase tracking-wide text-[#8a7f6f]">
...
//                   <label className="font-rethink text-xs uppercase tracking-wide text-[#8a7f6f]">
//                     Time{" "}
//                     <span className="text-[#b5aa98] normal-case">
//                       (optional)
//                     </span>
//                   </label>
//                   <input
...
//                 <label className="font-rethink text-xs uppercase tracking-wide text-[#8a7f6f]">
//                   Event image{" "}
//                   <span className="text-[#b5aa98] normal-case">(max 2MB)</span>
//                 </label>
...
//               <label className="font-rethink text-xs uppercase tracking-wide text-[#8a7f6f]">
//                 Tag{" "}
//                 <span className="text-[#b5aa98] normal-case">(optional)</span>
//               </label>
//               <input
//                 type="text"
//                 value={tag}
...
//                   }`}
//                   style={
//                     activeTab === g.id ? { backgroundColor: g.accent } : {}
//                   }
//                 >
//                   {g.label}{" "}
...
//                   if (activeTab === "all" && group.items.length === 0)
//                     return null;
//                   return (
//                     <div key={group.id}>
//                       {activeTab === "all" && (
...
/* ── Custom Institution dropdown (maroon themed) ──────────────────
   Defined at module/top level — never inside a render loop. */
function InstitutionSelect({ value, onChange }) {
  const [open, setOpen] = useState(false);
  const ref = useRef(null);
  const selected = INSTITUTIONS.find((i) => i.id === value) || INSTITUTIONS[0];
  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className={`flex w-full items-center justify-between rounded-lg border bg-white px-3 py-2.5 font-rethink text-sm text-[#2b2620] transition-colors ${
          open
            ? "border-[#ae1431] ring-2 ring-[#ae1431]/10"
            : "border-[#e3d6c3]"
        }`}
      >
        {selected.label}
        <ChevronDown
          size={15}
          className={`text-[#8a7f6f] transition-transform ${
            open ? "rotate-180" : ""
          }`}
        />
      </button>
      ...
      {open && (
        <div className="cursor-pointer absolute z-20 mt-1.5 w-full overflow-hidden rounded-xl border border-[#e3d6c3] bg-white shadow-[0_8px_28px_rgba(43,38,32,0.12)]">
          {INSTITUTIONS.map((inst) => {
            ...
            return (
              <button
                ...
                className={`w-full px-3.5 py-2.5 text-left font-rethink cursor-pointer text-sm transition-colors ${
                  isSelected
                    ? "bg-[#ae1431] font-semibold text-white"
                    : "text-[#2b2620] hover:bg-[#F5EFE8]"
                }`}
              >
                {inst.label}
              </button>
...
/* ── Custom Category dropdown (maroon themed) ─────────────────────
   Same pattern as InstitutionSelect — top level, never in a loop. */
