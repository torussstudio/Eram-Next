...
import { Trash2, CalendarPlus, Pin } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-10">
      ...
      >
        ...
        <div className="sm:col-span-2">
          <label className="font-rethink uppercase tracking-wide text-white">
            Tag <span className="text-white/40 normal-case">(optional, e.g. ADMISSIONS, RESULTS)</span>
          </label>
          <input
            type="text"
            value={tag}
        ...
        <div className="sm:col-span-2 flex items-center gap-2">
          <input
            ...
            className="h-4 w-4"
          />
          <label htmlFor="isPinned" className="font-rethink uppercase tracking-wide text-white">
            Pin this item
          </label>
        </div>
                            ...
                            <div className="flex items-center justify-end gap-3">
                              <button
                                ...
                                className={`cursor-pointer transition-colors ${
                                  item.isPinned ? "text-amber-400" : "text-white hover:text-amber-400"
                                }`}
                                aria-label="Pin"
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-6">
          <div className="w-full max-w-sm rounded-md border border-white/10 bg-black p-6">
            <h3 className="font-display text-lg text-white">Delete this event?</h3>
