                    ...
                    >
                      <div className="relative aspect-video w-full overflow-hidden bg-[#F5EFE8]">
                        ...
                        <button
                          ...
                          aria-label="Delete"
                          className="absolute right-2 cursor-pointer top-2 rounded-full bg-white/90 p-1.5 text-[#8a7f6f] opacity-0 shadow-sm transition-all hover:bg-white hover:text-[#ae1431] group-hover:opacity-100"
                        >
                          <Trash2 size={14} />
                        </button>
                        <span
          ...
          <div className="w-full max-w-sm rounded-xl border border-[#e3d6c3] bg-white p-6 shadow-[0_8px_24px_rgba(43,38,32,0.12)]">
            ...
            <div className="mt-6 flex justify-end gap-3">
              <button
                ...
                className="rounded-md cursor-pointer border border-[#e3d6c3] px-4 py-2 text-xs font-rethink font-medium uppercase tracking-wide text-[#2b2620] transition-colors hover:border-[#8a7f6f]"
              >
                No
              </button>
              <button
                onClick={handleDelete}
                className="rounded-md bg-[#ae1431] cursor-pointer px-4 py-2 text-xs font-rethink font-medium uppercase tracking-wide text-white transition-colors hover:bg-[#9a1129]"
              >
                Yes
              </button>
            </div>
