...
//       <button
//         onClick={() => setOpen((v) => !v)}
//         style={{ color: isHome ? "#F5EFE8" : "#111111", transition: `color ${T}` }}
//         className="relative pb-[5px] text-[0.92rem] lg:text-[0.97rem] xl:text-[1rem] font-semibold uppercase tracking-[0.05em] cursor-pointer whitespace-nowrap flex items-center gap-[5px]"
//       >
//         INSTITUTIONS
//         <svg
...
//         >
//           <path d="M2 4.5L6 8l4-3.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
//         </svg>
//         <span
//           style={{
...
//             <button
//               key={inst.title}
//               onClick={() => { setOpen(false); onItemClick(inst.path); }}
...
//                 <img src={inst.image} alt={inst.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
//               </div>
//               <span className="text-[0.85rem] font-semibold text-[#111] tracking-[0.02em] flex-1">{inst.title}</span>
//               <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-[#aaa] group-hover:text-[#ae1431] transition-colors duration-150 shrink-0">
...
//         (inst) => !inst.path.startsWith("http") && location.pathname.startsWith(inst.path),
//       );
//       setActiveSection(matched ? matched.path : instMatch ? "institutions" : null);
//       return;
//     }
...
//           style={{ color: isHome ? "#F5EFE8" : "#111111", transition: `color ${T}` }}
//           className="relative pb-[5px] text-[0.92rem] lg:text-[0.97rem] xl:text-[1rem] font-semibold uppercase tracking-[0.05em] cursor-pointer whitespace-nowrap"
//         >
//           {item.label}
//           <span
//             style={{
...
//         "
//       >
//         {/* ── LOGO — both images stacked, only opacity transitions ── */}
//         <Link to="/" className="shrink-0 flex items-center self-stretch" style={{ minWidth: "150px" }}>
//           <span
//             style={{
//               backgroundColor: isHome ? "#ae1431" : "#F5EFE8",
//               transition: `background-color ${T}`,
...
//           >
//             {/*
//               ✅ Fix: both logos always "relative" inside a fixed-size container.
//               Only opacity changes — no position swap, no layout jump/jerk.
//             */}
...
//         {/* ── OVERLAY ───────────────────────────────────────────── */}
//         <div
//           className={`fixed inset-0 z-[100] bg-black/50 backdrop-blur-sm transition-opacity duration-300 ${open ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"} min-[920px]:hidden`}
//           onClick={() => setOpen(false)}
//         />

//         {/* ── MOBILE MENU ───────────────────────────────────────── */}
//         <div
//           className={`fixed top-0 right-0 z-[110] h-[100dvh] w-full bg-[#F5EFE8] flex flex-col shadow-2xl transition-transform duration-500 ease-out ${open ? "translate-x-0" : "translate-x-full"} min-[920px]:hidden`}
//         >
//           <div className="flex items-center justify-between px-6 py-5 border-b border-black/10">
//             <span className="font-display font-bold text-xl text-[#ae1431]">ERAM.</span>
//             <button onClick={() => setOpen(false)} className="h-9 w-9 flex items-center justify-center rounded-full bg-black/5 text-[#111]">✕</button>
//           </div>
...
//                         style={{ transition: "transform 250ms ease", transform: mobileInstitutionsOpen ? "rotate(180deg)" : "rotate(0deg)" }}>
//                         <path d="M2 4.5L6 8l4-3.5" stroke="#111" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
//                       </svg>
//                     </button>
//                     <div style={{ maxHeight: mobileInstitutionsOpen ? "400px" : "0px", transition: "max-height 350ms cubic-bezier(0.4,0,0.2,1)", overflow: "hidden" }}>
//                       <div className="py-2 flex flex-col gap-1">
//                         {institutions.map((inst) => (
//                           <button
//                             key={inst.title}
//                             onClick={() => { setOpen(false); setMobileInstitutionsOpen(false); handleNavClick(inst.path); }}
...
//                               <img src={inst.image} alt={inst.title} className="w-full h-full object-cover" />
//                             </div>
//                             <span className="text-[0.9rem] font-medium text-[#111] flex-1">{inst.title}</span>
//                             <svg width="13" height="13" viewBox="0 0 14 14" fill="none" className="text-[#bbb] shrink-0">
//                               <path d="M3 7h8M7.5 4l3.5 3-3.5 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
//                             </svg>
//                           </button>
//                         ))}
