...
//       } else {
//         // ─────────────────────────────────────────────
//         // MOBILE ANIMATIONS (premium & different)
//         // ─────────────────────────────────────────────
...
//                     className="
//                       absolute
//                       top-5 left-5 md:top-10 md:left-12
//                       text-[14px] md:text-[18px] text-white
//                     "
//                   >
//                     {card.num}
//                   </span>
...
//         {/* ══════════════════════════════
//             PROFILE CARDS  — with hover message overlay
//         ══════════════════════════════ */}
//         <div
//           className="
//             mt-10 md:mt-12
//             grid grid-cols-1 md:grid-cols-[460px_460px]
//             justify-center
//             gap-5 md:gap-8
//           "
//         >
...
//                     alt={person.alt}
//                     className={`
//                       w-full h-full object-cover grayscale block ${person.objPos}
...
//                   Sits above the image; fades in on hover.
//                   Uses pointer-events-none so it never blocks scrolling when hidden. */}
//               <div
//                 className="
//                   absolute inset-0
//                   flex flex-col justify-center items-center
//                   px-7 md:px-10
//                   bg-[#b5122b]/70 backdrop-blur-[1px]
...
//               {/* ── MOBILE OVERLAY (name/role at bottom, unchanged) ── */}
//               <div className="md:hidden">
//                 <div
//                   className="
//                     absolute inset-x-0 bottom-0 h-[150px]
...
//                 <div
//                   className="
//                     absolute bottom-0 left-0 right-0 px-5 pb-5
//                     transition-opacity duration-500
//                     group-hover:opacity-0
//                   "
//                 >
...
//                       <p className="text-[20px] font-semibold text-white leading-tight tracking-[0.2px] truncate">
//                         {person.name}
//                       </p>
//                       <p className="mt-[3px] text-[11px] text-white/65 font-medium uppercase tracking-widest leading-snug">
//                         {person.role}
//                       </p>
//                     </div>
//                     <span className="text-[36px] font-bold text-white/10 leading-none select-none flex-shrink-0">
//                       {person.num}
//                     </span>
//                   </div>
//                 </div>
...
//               {/* ── DESKTOP CHIP (name/role, fades out on hover) ── */}
//               <div
//                 className="
//                   absolute bottom-6 left-6 hidden md:block
//                   w-[380px] max-w-[90%]
//                   bg-black/55 backdrop-blur-md px-5 py-4 rounded-2xl
//                   transition-opacity duration-500
//                   group-hover:opacity-0
//                 "
//               >
...
//             md:opacity-0 md:translate-y-8
//             mt-16 md:mt-20
//             text-[24px] sm:text-[28px] md:text-[40px] lg:text-[48px]
//             font-medium leading-[1.2]
//             text-white
//             max-w-full md:max-w-[980px]
//             ml-0 md:ml-22
//           "
//         >
...
function StructuredLearningSection() {
  ...
  const PROFILES = [
    {
      src: "/images/person1.webp", alt: "Dr. Siddeek Ahmed",
      objPos: "object-[72%_center]", name: "Dr. Siddeek Ahmed",
      role: "Chairman & MD - ERAM Holdings", num: "01",
      messageTitle: "Chairman's Message",
      message: "Education is a powerful force that shapes intellect, character, and values. At ERAM, we are committed to providing value-based quality education to every student, irrespective of background. Through structured learning and strong moral principles, we aim to nurture disciplined, responsible individuals who strive for excellence and contribute meaningfully to society. May God Almighty bless us all!",
    },
    {
      src: "/images/person2.webp", alt: "Mr. Abdussamod C K",
      objPos: "object-[15%_20%]", name: "Mr. Abdussamod C K",
      role: "School Manager, Karuna Educational Welfare Trust (AMLP)", num: "02",
      messageTitle: "Manager's Message",
      message: "Education is a shared commitment between dedicated teachers, motivated students, and supportive parents. At ERAM, we focus on quality learning supported by technology-enabled pedagogy and holistic development. Through academic and co-curricular engagement, workshops, and structured guidance, we nurture talent, strengthen character, and instill moral values, preparing students to grow as responsible and capable citizens.",
    },
  ];
          ...
          {PROFILES.map((person, i) => (
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 px-5 pb-5">
                  <div className="flex items-end justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="mt-[3px] text-[11px] text-white/65 font-medium uppercase tracking-widest leading-snug">{person.role}</p>
                    </div>
              ...
              <div className="absolute bottom-6 left-6 hidden md:block w-[380px] max-w-[90%] bg-black/55 backdrop-blur-md px-5 py-4 rounded-2xl">
                ...
                <p className="font-rethink mt-1 text-[13px] text-white/75 font-medium leading-snug">– {person.role}</p>
              </div>
            </div>
          ))}
        </div>
