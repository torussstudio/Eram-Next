...
//         {/* DIVIDER (moved down with the cards section) */}
//         <div className="my-12 md:my-16 border-t border-white/40" />

//         {/* TOP GRID (cards section moved to bottom) */}
//         <div
//           className="
//             grid
...
const router = useRouter()
  ...
  const toggleProfile = useCallback((index: number) => {
    setExpandedProfile((prev) => (prev === index ? null : index));
  }, []);
        ...
        >
          {PROFILES.map((person, i) => (
            ...
            >
              ...
              {/* MESSAGE OVERLAY (MOBILE - toggled via arrow) */}
              <div
                className={`
                  md:hidden
                ...
                `}
              >
                <span className="block w-10 h-[2px] bg-white/50 mb-4 rounded-full" />
                ...
                <span className="block w-10 h-[2px] bg-white/50 mt-4 rounded-full" />
              </div>
              ...
              >
                <ChevronDown
                  ...
                  className={`
                    ...
                    ${expandedProfile === i ? "rotate-180" : "rotate-0"}
                  `}
                />
              </button>

              {/* MOBILE INFO (NAME CHIP - always full opacity) */}
              <div className="md:hidden absolute bottom-5 left-5 right-16 z-20">
                <div
                  className="
                    rounded-2xl
