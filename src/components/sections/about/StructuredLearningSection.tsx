...
//     const cardWidth = card ? card.offsetWidth + 16 : 260; // card width + gap
...
//         gsap.utils.toArray<HTMLElement>(".leadership-profile").forEach((profile) => {
...
//         gsap.utils.toArray<HTMLElement>(".leadership-profile").forEach((el, i) => {
//           gsap.fromTo(el,
...
//                 className="w-12 h-12 rounded-full border border-white/50 flex items-center justify-center hover:bg-transparent hover:text-white hover:border-none hover:scale-90 transition-300 transition-colors cursor-pointer"
//               >
//                 <ChevronLeft size={18} />
//               </button>
//               <button
...
//             <div
//               ref={scrollRef}
//               className="flex gap-4 md:gap-5 overflow-x-auto scroll-smooth scrollbar-hide px-5 md:px-0 pb-2"
//             >
//               {CARDS.map((card, i) => (
...
//           <h3 className="leadership-text md:opacity-0 md:translate-y-8 font-display text-[1.08rem] sm:text-[26px] md:text-[32px] leading-snug ml-10 md:ml-[90px]">
