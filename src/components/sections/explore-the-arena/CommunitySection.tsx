...
// // Cycled purely for visual variety in the list — the events themselves are
// // real data pulled from the admin Events & Notifications manager, filtered
// // to category === "sports".
// const ICONS = ["🏆", "🏅", "🎯", "⚡"];
