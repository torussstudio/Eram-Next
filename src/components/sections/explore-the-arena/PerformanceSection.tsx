...
function PerformanceSection() {
  ...
  useGSAP(
    () => {
      ...
      const buildStack = (scrollEndPx: number) => {
  ...
  return (
    <div ref={containerRef}>
      {/* ══════════════════════════════════════════
          SECTION 1 — Heading
      ══════════════════════════════════════════ */}
      <section className="bg-[#F5EFE8] overflow-hidden pb-8 px-5 md:pb-10 md:px-6">
        <div className="w-full md:max-w-[1100px] md:mx-auto">
          <div className="text-center max-w-[680px] mx-auto">
            ...
            {/* Heading */}
            <h2 className="font-display text-[30px] sm:text-[38px] md:text-[48px] font-semibold leading-[1.3] text-black">
