...
//       tl.to(headingRef.current, { opacity: 1, y: 0, skewY: 0, ease: "expo.out", duration: 0.16 }, 0.36);
//       tl.to(paraRef.current,    { opacity: 1, y: 0, ease: "power3.out", duration: 0.16 }, 0.48);
//       tl.to(btnsRef.current,    { opacity: 1, y: 0, ease: "power2.out", duration: 0.14 }, 0.58);
...
//         }}
//       >
//         {/* ✅ Mobile-only height control — inline style instead of calc */}
//         <style>{`
...
//           style={{
//             background: "black",
//             opacity: 0.45,          // ✅ mobile-ൽ image കാണാൻ lighter overlay
//             willChange: "opacity",
//             backfaceVisibility: "hidden",
//           }}
//         />
