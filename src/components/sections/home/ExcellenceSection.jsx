...
//         ease: "power2.in",
//         onComplete: () => {
//           // ✅ Clear ALL inline GSAP transforms before React re-renders new cards
...
//       );
//     } else {
//       // ✅ Explicitly reset x & y to 0 so stale transforms don't carry over
//       gsap.fromTo(
//         ".mob-exc-card",
//         { opacity: 0, x: 0, y: 0 },
//         {
...
//         // ✅ Only set entrance state — no premature clearProps
...
//           stagger: { amount: 0.3 },
//           ease: "power3.out",
//           clearProps: "all", // ✅ Clean up after scroll entrance so tab-switch works cleanly
//           scrollTrigger: t2,
//         });
//         gsap.to(".mob-exc-btn", {
//           y: 0,
...
//     >
//       {/* ── Desktop ≥ 900px ─────────────────────────────────────── */}
//       <div className="mx-auto hidden max-w-[1180px] items-start grid-cols-[240px_1fr] gap-16 px-6 min-[900px]:grid">
//         {/* Sidebar nav */}
//      <aside className="sticky top-[120px] h-fit flex flex-col gap-5 pt-5">
...
//       {/* ── Mobile < 900px ──────────────────────────────────────── */}
//       <div className="w-full overflow-hidden px-4 min-[900px]:hidden">
//         {/* Heading */}
//         <div className="mb-9">
...
//         {/* ✅ overflow-hidden added to prevent shifted cards from bleeding outside */}
//         <div className="mob-exc-grid mb-6 grid grid-cols-2 gap-2 sm:gap-2.5 overflow-hidden">
//           {currentCards.map((item, i) => (
//             <ImageCard
//               key={i}
//               src={item.image}
