...
export default function ImpactSection() {
  ...
  useGSAP(() => {
    ...
    cardsTl.fromTo(
      ...
      isMobile ? { opacity: 1, y: 0, scale: 1, duration: 0.5, ease: "back.out(1.6)" } : { opacity: 1, y: 0, duration: 0.7, ease: ease2 }
    );
  ...
  return (
    <section
      ref={sectionRef}
      className={`${section} bg-[#ae1431] !pt-[52px] !pb-[52px] max-[640px]:!pt-[36px] max-[640px]:!pb-[36px]`}
      id="impact"
    >
      ...
      <div className="hidden max-[640px]:flex flex-col gap-5 px-5">
        <div className="flex w-full items-end gap-3">
          <ImpactImage src="/images/impact1.webp" alt="Students" className="mob-img h-[150px] flex-1 rounded-[18px]" />
          <ImpactImage src="/images/impact2.webp" alt="Campus"   className="mob-img h-[185px] flex-1 rounded-[18px]" />
        </div>
