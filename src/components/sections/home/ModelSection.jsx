...
export default function ModelSection() {
  ...
  return (
    ...
    >
      ...
      {/* Wrapper — flex column on mobile to control order */}
      <div
        className="
          max-w-[1180px] mx-auto px-[24px] relative
          max-[640px]:flex max-[640px]:flex-col
        "
      >

        {/* Heading block — order-1 on mobile */}
        <div
          className="
            model-heading
            max-w-[640px]
        ...
        {/* Mobile-only video — order-2 on mobile */}
        <div
          className="
            hidden
            max-[640px]:block
        ...
        {/* Pillars container — order-3 on mobile (above carousel) */}
        <div
          className="
            model-pillars-container
            mt-[70px]
        ...
        {/* Academic systems Carousel — order-4 on mobile (below pillars) */}
        <div
          className="
