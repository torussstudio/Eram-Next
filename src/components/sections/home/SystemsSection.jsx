...
//        {/* Content */}
// <div className={`mx-auto w-[min(1200px,calc(100vw-120px))] flex items-start gap-[80px] ${activeTab !== 2 ? 'justify-center' : ''}`}>

//   {/* Text — show ONLY on tab 3 */}
//   {activeTab === 2 && (
//     <div className="max-w-[420px] ml-[40px] flex-shrink-0">
...
//   {/* Cards + Arrows */}
//   <div className={`flex items-center gap-[14px] min-w-0 ${activeTab !== 2 ? 'w-full' : 'flex-1'}`}>
//     {/* ← Left */}
//     {activeTab !== 1 && (
...
//     overflow-hidden rounded-[22px] p-[34px]
//     bg-black
//   "
//   style={{
//     width: activeTab !== 2 ? 'calc(25% - 14px)' : '320px',
//     height: activeTab !== 2 ? '320px' : '220px',
//   }}
// >
//           <img
//             src={card.img}
...
//                 onClick={() => {
//                   setActiveCard(i);
//                   pulseEl(mobCardRefs, i, 0.94, 0.1);
//                 }}
...
//                   style={{
//                     background: isActive ? "rgba(255,255,255,0.18)" : "#1d1d1d",
