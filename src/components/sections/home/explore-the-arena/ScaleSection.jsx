    ...
    <section className="bg-[#0d0d0d] text-white py-[90px] md:py-[110px] px-[16px] sm:px-[20px] md:px-[28px]">
      ...
      <div className="max-w-[1500px] mx-auto px-[10px] md:px-[12px]">
        <div className="max-w-[1100px] mx-auto px-[16px] sm:px-[20px] md:px-[28px]">
          ...
          {/* TOP GRID */}
          <div className="grid md:grid-cols-2 gap-[40px] md:gap-[80px] items-start mb-[50px] md:mb-[70px]">

            {/* LEFT */}
            <div>
              <div className="flex items-center gap-3 mb-[20px]">
                <span className="w-[24px] h-[1px] bg-[#a32020]" />
            ...
            {/* RIGHT */}
            <p className="text-[14px] md:text-[15px] leading-[1.8] md:leading-[1.9] text-[#b8b2a8] max-w-[520px]">
          ...
          {/* GRID */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 border border-[#2a2a2a]">

            {cards.map((card, i) => (
              <div
                key={i}
                className={`
                  p-[22px] sm:p-[26px] md:p-[30px]
              ...
              >
                ...
                <p className="text-[10px] tracking-[0.2em] text-[#8f877d] uppercase mb-[10px]">
                  {card.label}
                </p>
