...
// // This page belongs to AMLP — only images uploaded under the
// // "amlp" school category (from the admin Gallery Manager) show here.
// const SCHOOL_CATEGORY = "amlp";
  ...
  useEffect(() => {
    ...
    api
      ...
      .then(({ data }) => {
        ...
        // the full set (filtered to AMLP) lives on the main Gallery page.
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* SHOW MORE — sends visitor to the main Gallery page,
              pre-filtered to AMLP, only if more than the preview exists. */}
          {!loading && totalCount > PREVIEW_LIMIT && (
            <div className="mt-12 flex justify-center">
              <Link
                href="/gallery?category=amlp"
