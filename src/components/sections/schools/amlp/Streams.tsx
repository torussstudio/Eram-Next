...
import { BarChart2, NotebookText, BookOpen } from "lucide-react";
...
const streams = [
  {
    ...
    title: "Structured Lesson Execution",
    sub: "Kerala State Syllabus · Malayalam Medium",
  },
  {
    icon: <NotebookText size={18} />,
    title: "Continuous Formative Assessment",
    sub: "Regular progressive evaluation",
  },
  {
    icon: <BarChart2 size={18} />,
    title: "Teacher-Led Engagement",
    sub: "Supervised learning at every stage",
  },
];
