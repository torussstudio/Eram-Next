...
const milestones = [
  ...
  {
    year: "2011",
    title: "Result Improvement Strategy Strengthened",
    desc: "Structured academic supervision, crash courses, and focused support for average and weak learners contribute to a significant upward shift in overall performance.",
  },
  {
    year: "2015",
          ...
          <div className="flex flex-col">
            ...
            >
              <p className="font-rethink font-bold text-[#ae1431] text-[16px] sm:text-[18px] md:text-[19px] leading-[1.65]">
                "Top 10 Among 150 Schools in Palakkad District"
              </p>
            </blockquote>
