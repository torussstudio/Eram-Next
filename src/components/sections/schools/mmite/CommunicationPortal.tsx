...
const feedItems = [
  {
    text: "D.El.Ed 2026–27 Admissions Now Open. Eligibility: +2 Pass. Intake limited to 50 students per batch. Application window closes on [Date].",
    meta: "Admissions · 1 hour ago",
  },
  {
    text: "15-Day Residential Camp – Dates Confirmed. Leadership and empathy development programme scheduled [Start Date] to [End Date].",
    meta: "Programme · 2 hour ago",
  },
  {
    text: "KTET 2025 Results Announced – 45 of 53 Cleared. Qualification outcome reflects focused preparation and academic supervision across the two-year programme.",
    meta: "Academic · yesterday",
  },
];
