...
// // This page belongs to MMITE — only images uploaded under the
// // "mmite" school category (from the admin Gallery Manager) show here.
// const SCHOOL_CATEGORY = "mmite";
  ...
  useEffect(() => {
    ...
    api
      ...
      .then(({ data }) => {
        ...
        // the full set (filtered to MMITE) lives on the main Gallery page.
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* SHOW MORE — sends visitor to the main Gallery page,
              pre-filtered to MMITE, only if more than the preview exists. */}
          {!loading && totalCount > PREVIEW_LIMIT && (
            <div className="mt-12 flex justify-center">
              <Link
                href="/gallery?category=mmite"
