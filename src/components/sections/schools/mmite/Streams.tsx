...
const streams = [
  {
    ...
    title: "D.El.Ed — Theoretical Foundations",
    sub: "Education theory, child psychology & development",
  },
  {
    icon: <Monitor size={18} />,
    title: "Pedagogical Methodology",
    sub: "Classroom management & structured teaching",
  },
  {
    icon: <BarChart2 size={18} />,
    title: "Practical Teaching Assignments",
    sub: "Structured internal assessment & internships",
  },
];
     ...
     <div className="w-full max-w-[1300px] mx-auto px-5 sm:px-8 md:px-10 lg:px-16 py-6 sm:py-14 md:py-20 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24">
          ...
          <div className="flex flex-col">
            ...
            >
              {[["A", "Framework"], ["Built", "for"], ["Teaching."]].map(
                (line, li) => (
            ...
            >
              The D.El.Ed programme at MMITE follows a two-year, four-semester
              structure comprising 14 academic papers aligned with NCERT / SCERT
              standards. The focus is not theoretical knowledge alone — but the
              formation of disciplined educators capable of leading classrooms
              independently.
            </p>
            <br></br>
            {/* Streams list */}
