...
const supportItems = [
  [
    "Categorized student attention by performance level",
    "Regular internal assessments across all grades",
  ],
  [
    ...
    >
      <div className="w-full max-w-[1300px] mx-auto px-5 sm:px-8 md:px-10 lg:px-16 pt-8 md:pt-10 lg:pt-12 pb-16 md:pb-20 lg:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24">
          ...
          <div
            ref={principalRef}
            className="group relative overflow-hidden mt-2 lg:mt-6 rounded-[28px] h-[380px] md:h-[420px] border border-white/10"
          >
            {/* Principal Image */}
            <img
              src="/images/hm-mmps.avif"
              alt="Principal"
              className="w-full h-full object-cover opacity-[0.80] transition-all duration-700"
            />
