        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="font-display anim-hero-title text-[#1a1209] text-3xl md:text-4xl lg:text-5xl leading-[1.05] tracking-[-0.02em] mb-8">
              Begin the Journey at MMPS.
            </h1>

            <p className="font-rethink anim-hero-desc text-[#3a3228] text-[14.5px] md:text-[15.5px] leading-relaxed max-w-sm">
              Admissions are now open at Mariyumma Memorial Public School. Join
              an institution with a proven record of academic excellence,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-1 rounded-2xl overflow-hidden">
            {institutions.map((inst, i) => {
              ...
              return isActive ? (
                ...
                >
                  <p className="text-[10px] font-rethink tracking-widest uppercase text-[#8a8278] group-hover:text-white/50 mb-3 transition-colors duration-200">
                    {inst.type}
                  </p>
                  <p className=" text-[#1a1209] group-hover:text-white text-xl font-display mb-1 transition-colors duration-200">
                    {inst.name}
                  </p>
