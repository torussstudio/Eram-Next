...
function AcademicFocusSection() {
  ...
  return (
    <section className="relative -mt-10 rounded-[28px] bg-[#F5EFE8] px-8 pt-8 pb-2 sm:px-12 sm:pt-10 sm:pb-3 lg:px-16 lg:pt-12 lg:pb-4">
          ...
          >
            {active.items.map((item, idx) => (
              ...
              >
                ...
                <span className="font-rethink block text-[16x] text-black">
