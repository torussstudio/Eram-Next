...
function InkHeading({ text, active }) {
  ...
  return (
    <h2
      className="font-serif text-[clamp(2.4rem,3.5vw,3.6rem)] leading-[1.15] text-[#1a1a1a] font-light"
      style={{ margin: 0 }}
    >
      {words.map((word, i) => (
        <span
...
function TypewriterQuote({ text, active }) {
  ...
  return (
    <p style={{
      marginTop: 20, fontSize: 13, fontStyle: "italic",
    ...
    >
      {index !== 0 && (
        <span className="stat-divider" style={{
          ...
          height: 60, width: 1, background: "rgba(255,255,255,0.1)",
        }} />
      )}
      ...
      <h3 className="font-serif text-[clamp(2rem,2.5vw,2.8rem)]"
        style={{
...
function AnimatedDivider({ active }) {
  return (
    <svg width="100%" height="20" viewBox="0 0 1100 20"
      preserveAspectRatio="none" style={{ display: "block" }}>
      <line x1="0" y1="10" x2="1100" y2="10"
      ...
      />
      <circle cx="550" cy="10" r="3" fill="#8B1E1E"
        style={{
          opacity: active ? 1 : 0,
...
export default function CommitmentSection() {
  ...
  return (
    <section className="bg-[#F5EFE8] overflow-hidden">
      ...
      {/* TOP CONTENT */}
      <div ref={topRef} className="max-w-[1100px] mx-auto px-[12px] py-[90px]">
        <div className="grid md:grid-cols-2 gap-[80px]">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              <span
                className="w-[30px] h-[1.5px] bg-[#8B1E1E]"
                style={{
                  display: "block",
            ...
            {/* UNDERLINE */}
            <div
              className="w-[50px] h-[2px] bg-[#8B1E1E] mt-6"
              style={{
                transformOrigin: "left center",
                transform: topVisible ? "scaleX(1)" : "scaleX(0)",
                transition: "transform 0.55s ease 0.65s",
              }}
            />
      ...
      {/* DIVIDER */}
      <div ref={lineRef} className="max-w-[1100px] mx-auto px-[12px]">
      ...
      <div
        ref={stripRef}
        className="bg-[#0E0E0E] py-[70px]"
        style={{ position: "relative", overflow: "hidden" }}
      >
        <Scanlines />
        <div
          className="max-w-[1100px] mx-auto px-[12px] grid grid-cols-2 md:grid-cols-4 text-center"
