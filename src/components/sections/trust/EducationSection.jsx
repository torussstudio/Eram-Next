...
//             {/* TOP WHITE CARD */}
//             <div className="border border-black/10 bg-white/40 p-[28px] mb-[20px] grid md:grid-cols-2 gap-[40px]">
//               {/* LEFT */}
//               <div>
//                 <span className="text-[10px] uppercase text-[#8B1E1E]">
//                   PALAKKAD DISTRICT
//                 </span>
...
//                 <p className="mt-3 text-[13px] text-black/70 leading-[1.7]">
...
//               {/* RIGHT */}
//               <div>
//                 <p className="text-[13px] text-black/70 leading-[1.7]">
...
//                 <ul className="mt-4 space-y-2 text-[13px] list-disc pl-4 marker:text-[#8B1E1E] text-black/70">
...
//                 <p className="mt-4 text-[13px] text-black/70 leading-[1.7]">
...
//               {/* RED CARD */}
//               <div className="bg-[#8B1E1E] text-white p-[26px]">
...
//                 <p className="mt-3 text-[13px] text-white/80 leading-[1.7]">
...
//                 <ul className="mt-4 space-y-2 text-[13px] list-disc pl-4 marker:text-white">
...
//               {/* DARK CARD */}
//               <div className="bg-[#111111] text-white p-[26px]">
...
//                 <ul className="mt-4 space-y-2 text-[13px] list-disc pl-4 marker:text-[#8B1E1E]">
...
//                 <div className="mt-6 bg-white/10 px-4 py-3 inline-block">
...
//               {/* WHITE CARD 1 */}
//               <div className="border border-black/10 bg-white/40 p-[26px]">
//                 <span className="text-[10px] uppercase text-[#8B1E1E]">
//                   2015 · MANKARA
//                 </span>
...
//                 <div className="mt-6 bg-[#8B1E1E] text-white px-4 py-3 inline-block">
...
//                 <p className="mt-4 text-[13px] text-white/80 leading-[1.7]">
...
//               {/* RIGHT BOX */}
//               <div className="bg-[#E9E1D6] p-[20px] h-fit">
