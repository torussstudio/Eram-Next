  ...
  return (
    <section ref={sectionRef} className="bg-[#F5EFE8] py-[clamp(60px,10vw,120px)] overflow-hidden relative">
      <div className="max-w-[1100px] mx-auto px-[clamp(16px,5vw,40px)] relative z-10">
        <div className="grid md:grid-cols-2 gap-[clamp(32px,5vw,60px)] items-start">
          ...
          {/* ── RIGHT ── */}
          <div className="flex flex-col gap-4 md:items-end md:mt-10">

            {/* Primary button */}
            <button
              ref={btn1Ref}
              className="group relative bg-[#111] text-white px-[clamp(20px,2.5vw,30px)] py-[clamp(12px,1.5vw,15px)] text-[11px] tracking-[0.18em] uppercase flex items-center gap-3 overflow-hidden"
            >
              {/* wipe reveal */}
            ...
            <button
              ref={btn2Ref}
              className="group relative border border-black/35 text-[#111] px-[clamp(20px,2.5vw,30px)] py-[clamp(12px,1.5vw,15px)] text-[11px] tracking-[0.18em] uppercase flex items-center gap-3 overflow-hidden"
            >
