...
//             >
//               <span className="text-[12px] text-[#ae1431] tracking-[0.1em]">
//                 {item.no}
//               </span>

//               <div>
//                 <h3 className="mt-3 font-serif text-[#ae1431] text-[18px]">{item.title}</h3>

//                 <p className="mt-3 text-[13px] text-[#ae1431] leading-[1.7]">
//                   {item.desc}
//                 </p>
//               </div>
//             </div>
        ...
        <div className="mt-16 grid md:grid-cols-4 gap-[1px] bg-white/10">
          {cards.map((item, i) => (
            ...
            >
              ...
              <div>
                <h3 className="mt-3 font-serif text-[#ae1431] text-[18px]">
                  {item.title}
                </h3>
                <p className="mt-3 text-[13px] text-[#ae1431] leading-[1.7]">
                  {item.desc}
