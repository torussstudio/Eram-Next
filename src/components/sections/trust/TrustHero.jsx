...
//                 <span className="hero-heading-line">Purpose in Action.</span>

//                 <span className="hero-heading-line">Responsibility</span>

//                 <span className="hero-heading-line ">in Structure.</span>
//               </h1>
        ...
        <div className="relative h-[560px] sm:h-[620px] md:h-[660px] lg:h-[760px] w-full">
          ...
          <div className="absolute inset-0 flex items-center md:items-center">
            ...
            <div className="w-full flex flex-col items-center text-center text-white px-6 pb-10 md:hidden">
              ...
              {/* TOP LABEL — ✅ no opacity-0/translate classes, GSAP handles it */}
              <span className="font-rethink hero-content-fade text-[10px] tracking-[0.25em] uppercase text-white/70 mb-4">
                ERAM EDUCATIONAL & WELFARE TRUST
              </span>
              ...
              <h1 className="font-display text-white leading-[1.15] text-[clamp(1.9rem,7vw,2.5rem)] tracking-[-0.03em]">
                <span className="block overflow-hidden">
                  <span className="hero-heading-line block">Purpose in Action.</span>
                </span>
                <span className="block overflow-hidden">
                  <span className="hero-heading-line block">Responsibility</span>
                </span>
                <span className="block overflow-hidden">
            ...
            <div className="hidden md:block w-full text-white pl-[130px] pr-8 lg:pl-[180px]">
              <div className="max-w-[640px]">
                ...
                <p className="font-rethink hero-content-fade mt-6 text-[1.05rem] text-white/85 leading-relaxed">
                  ...
                  advances structured community initiatives focused on education,
                  healthcare, sanitation, and social equity. Its work is guided by
                  the principle: sustainable impact must be deliberate, measurable,
                  and accountable.
                </p>
