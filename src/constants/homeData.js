...
export const impactCards = [
  {
    ...
    description: 'Improving access to learning for underrepresented and financially vulnerable communities.',
  },
  {
    code: '/02',
    title: 'Healthcare Outreach',
    description: 'Targeted welfare initiatives that support family wellbeing and community resilience.',
  },
  {
    code: '/03',
    title: 'Educational Access',
    description: 'Programs that widen the pathway into disciplined, high-quality institutions.',
  },
  {
    code: '/04',
    title: 'Community Resilience',
    description: 'Trust-led initiatives designed to strengthen social support systems around education.',
  },
]
